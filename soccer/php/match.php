...
<!-- <button type="submit" name="submit" value="submit" onClick="matches.php"></button>  -->
<input type="submit" name="submit" value="Submit" onClick="matches.php" class="button button1">
</form>
</tr>  
