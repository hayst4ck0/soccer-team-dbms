...
// if($inputchoice=="Player Name" || $inputchoice=="Player ID"){
	...
	// } 
	if($inputchoice=="Player ID")
{
	$sql="SELECT * FROM player where playerid='$inputtext'";
	$result=$conn->query($sql);
	?>
	<div class="s003">
<table>
...
if($inputchoice=="Player Name")
{
	$sql="SELECT * FROM player where fname='$inputtext'|| lname='$inputtext'";
	$result=$conn->query($sql);
	?>
	<div class="s003">
<table>
...
<th>Team</th>
	...
	<?php 
	echo "<tbody>";
	if ($result->num_rows > 0 && $inputchoice=="Coach Name" ) {
